 ...
 * ```
 */
export declare const addSpeechEvent: <T extends SpeechRecognition = typeof resolveSpeechWithGoogleSpeechV2>(client: Client, options?: SpeechOptions<T> | undefined) => {
    group?: string | undefined;
    shouldProcessSpeech?: ((user: import("discord.js").User) => boolean) | undefined;
    ignoreBots?: boolean | undefined;
    minimalVoiceMessageDuration?: number | undefined;
    speechRecognition?: typeof resolveSpeechWithGoogleSpeechV2 | undefined;
