...
module.exports = {
    data: {
        name: 'message chat',
        description: `Send any message after "message chat" that will be sent to your server's message channel.`,
    ...
    async execute(client, message, term) {
        ...
        if(channels[message.guild.id] && channels[message.guild.id].message) {
